...
<aside
    class="fixed top-0 right-0 z-[200] h-full w-full max-w-[340px] translate-x-full border-l border-[#E8E6E1] bg-white shadow-[-8px_0_32px_rgba(15,31,61,0.08)] transition-transform duration-300 ease-[cubic-bezier(0.22,1,0.36,1)]"
    id="right-sidebar"
    role="complementary"
