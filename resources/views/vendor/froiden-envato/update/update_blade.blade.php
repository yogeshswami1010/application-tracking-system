...
<div class="flex">
    <div class="w-full">
        ...
        @if (isset($updateVersionInfo['lastVersion']))
            ...
            <div class="bg-red-100 text-red-800 text-xs font-medium px-2.5 py-0.5 rounded dark:bg-red-900 dark:text-red-300 border border-red-400 mb-4">
                <ol class="mb-0">
            ...
            <div class="note bg-blue-100 p-2.5 rounded dark:bg-blue-900 dark:text-blue-300 text-blue-800">
                <div class="flex items-center space-x-2 rtl:space-x-reverse">
                    <div class="flex-1">
                        ...
                        <div class=" mt-3">Update Alternate</div>
                    </div>
                    <div class="flex justify-end mt-3">
                        <button
                            id="update-app"
                            type="button"
                            class="inline-flex items-center px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition"
                        >
                            <i class="fa fa-download mr-2"></i> Update Now
                        </button>
                    </div>
                </div>
