...
(function () {
    ...
    function renderTable() {
        ...
        data.forEach(function (j, i) {
            ...
            html += '<td class="px-4 py-3 align-middle"><div class="text-[13.5px] font-bold leading-snug text-[#1A1E2E]">' + esc(j.title) + '</div>';
            ...
            html += '<td class="px-4 py-3 align-middle"><div class="text-[11.5px] text-[#8892A0]">' + esc(j.company) + '</div></td>';
