...
{{-- This reuses the same right-sidebar applicant profile component your
     Job Applications page already uses (#right-sidebar-content / .show-detail).
     If your layout's sidebar markup lives in a partial, make sure this page
     extends a layout that includes it — same as job-applications/index.blade.php does. --}}
