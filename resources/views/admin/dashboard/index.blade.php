        ...
        <div class="min-w-0 flex-1">
            ...
            <div class="grid grid-cols-2 gap-3 xl:grid-cols-4">
                ...
                @if($user->cans('view_jobs'))
                    <a href="{{ route('admin.jobs.index') }}?status=ats" class="rd-sc rd-c-purple rd-a rd-a4">
                @else
                    <div class="rd-sc rd-sc-static rd-c-purple rd-a rd-a4">
                @endif
                ...
                @if($user->cans('view_job_applications'))
                    <a href="{{ route('admin.job-applications.index') }}" class="rd-sc rd-c-white rd-c-amber rd-a rd-a3">
                @else
