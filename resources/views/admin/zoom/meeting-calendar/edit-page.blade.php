...
@php
    ...
    $submitRoute = $submitRoute ?? route('admin.zoom-meeting.update', optional($event)->id);
@endphp

@section('page-title-html')
<div>
    <h1 class="text-[22px] font-extrabold tracking-tight text-[#0F1F3D]">
        @lang('app.edit') <span class="text-[20px] font-normal italic text-[#2563EB]" style="font-family:'Instrument Serif',serif;">@lang('modules.zoommeeting.meetingName')</span>
    </h1>
</div>
@endsection

@section('page-subtitle')
<p class="mt-1 text-[12.5px] text-[#8892A0]">
    @if ($isOccurrence)
        {{ __('modules.zoommeeting.occurrence') }} #{{ $event->occurrence_order }}
    @else
...
@section('content')
    <div class="min-h-screen bg-gray-50">
        ...
        {{-- <header class="bg-white border-b border-gray-200 sticky top-0 z-10">
            <div class="max-w-5xl mx-auto px-6 h-14 flex items-center gap-3">
                ...
                <nav class="flex items-center gap-1.5 text-sm text-gray-400">
                    <a href="{{ route('admin.zoom-meeting.index') }}"
                       class="hover:text-gray-700 transition-colors">@lang('menu.zoomMeeting')</a>
        ...
        <main class="max-w-5xl mx-auto px-6 py-10">
                ...
                <div class="flex items-center gap-3 mb-1">
                    ...
                    <div>
                        <h1 class="text-2xl font-800 text-slate-900 tracking-tight leading-none">
                            @lang('app.edit') <span class="text-blue-600 italic font-semibold">@lang('modules.zoommeeting.meetingName')</span>
                        </h1>
            ...
            @php
                // Keep $submitRoute coming from controller.
                $submitRoute = $submitRoute ?? route('admin.zoom-meeting.update', optional($meeting)->id);
            @endphp
                                            ...
                                            <div class="px-6 py-5 space-y-4">
                                                ...
                                                <div class="field-focus">
                                                    <label class="block text-xs font-bold text-slate-500 uppercase tracking-widest mb-2">
                                                        ...
                                                        <span class="normal-case font-normal text-slate-400">(@lang('app.optional'))</span>
                                                    </label>
                                    ...
                                    <div class="bg-white rounded-2xl border border-slate-100 shadow-sm shadow-slate-100 overflow-hidden fade-up">
                                        <div class="px-6 pt-5 pb-4 border-b border-slate-50">
                                            <div class="flex items-center gap-2.5">
                                                ...
                                                <h2 class="text-sm font-bold text-slate-700">@lang('app.options')</h2>
                                        ...
                                        <div class="bg-white rounded-2xl border border-slate-100 shadow-sm shadow-slate-100 overflow-hidden fade-up">
                                            ...
                                            <div class="px-6 py-5 space-y-4">
                                                <div>
                                                    ...
                                                    <div class="flex items-center justify-between gap-3 p-3 w-full bg-slate-50 rounded-xl border border-slate-100">
