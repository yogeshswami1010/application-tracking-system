...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Shanmuga Laravel Entrust expects this key and defaults to App\Models\User.
    | This app uses the legacy App\User model namespace.
    |
    */
    'user_model' => 'App\User',
    ...
    |--------------------------------------------------------------------------
    |
    | Shanmuga Laravel Entrust expects these model keys and defaults to
